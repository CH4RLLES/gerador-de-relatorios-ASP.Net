...
namespace GeradorRelatoriosWeb.Dominio.Entidades.PNCV_168
{
    public partial class TblRemessaDados
    {
        ...
        public TimeSpan? ColetaDadosHoraInicio { get; set; }
        public TimeSpan? ColetaDadosHoraTermino { get; set; }
        ...
        public int NumeroTentativaDescompactacao { get; set; }
        public bool IndicadorFalhaDescompactarArquivo { get; set; }

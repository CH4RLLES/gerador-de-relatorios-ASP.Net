...
namespace GeradorRelatoriosWeb.Dominio.Entidades.PNCV_168
{
    public partial class BD_SIOR_PNCV_168_2016Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=10.100.10.144\\SIOR;Initial Catalog=BD_SIOR_PNCV_168_2016;Persist Security Info=True;User ID=nestor.santos;Password=​Ns92878@;MultipleActiveResultSets=True"

...
{
    public partial class TblPncvestudoTecnicoMonitoramentoAcidenteAposInicioOperacao
    {
        public int CodigoPncvestudoTecnicoMonitoramentoAcidenteAposInicioOperacao { get; set; }
